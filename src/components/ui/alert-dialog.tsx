    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ...
          variant === "default" && "bg-popover text-popover-foreground ring-1 ring-foreground/10",
          variant === "glass" && "border border-amber-300/20 bg-background/40 text-foreground shadow-2xl shadow-black/40 ring-1 ring-white/10 backdrop-blur-xl",
          className,
        )}
        {...props}
      />
